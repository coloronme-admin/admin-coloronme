...
public class LoginService {
    ...
    public ResponseDto<SignupResponseDto> signup(ConsultantRequestDto consultantRequestDto) {
        ...
        Consultant member = new Consultant(consultantRequestDto, Authority.ROLE_USER);

        consultantRepository.save(member);
    ...
    public ResponseDto<LoginResponseDto> login(LoginRequestDto loginRequestDto, HttpServletResponse response) {
        // 이메일 있는지 확인
        Consultant member = consultantRepository.findByEmail(loginRequestDto.getEmail()).orElseThrow(
